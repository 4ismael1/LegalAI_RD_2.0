/*
  # Initialize API Limits and Message Counts

  1. Changes
    - Add unique constraint on role column in api_limits
    - Insert default API limits for user and admin roles
    - Initialize message counts for existing users
    
  2. Security
    - Ensures unique roles in api_limits
    - Safe initialization of message counts
*/
